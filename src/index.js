...
var campos_petroleo = $.ajax({
  url:"https://raw.githubusercontent.com/Cadastro-Marinho/BrasilData/master/ANP/campos_producao.geojson",
  dataType: "json",
  success: console.log("BLOCOS_EXPLORATÓRIOS data successfully loaded."),
  error: function (xhr) {
    alert(xhr.statusText);
...
$.when(latinamerica, falklands, eez, extensao, lme, fao).done(function() {
  ...
  var Esri_WorldImagery = L.tileLayer(
    'https://server.arcgisonline.com/ArcGIS/rest/services/World_Imagery/MapServer/tile/{z}/{y}/{x}', {
      ...
      attribution: 'Tiles &copy; Esri &mdash; Source: Esri, i-cubed, USDA, USGS, AEX, GeoEye, Getmapping, Aerogrid, IGN, IGP, UPR-EGP, and the GIS ommunity'
  });
  ...
  function getBlocoColor(feature){
    console.log(feature);
    	switch (feature.properties.RODADA){
    	  case 'Rodada 2': return '#32D18A';
      	case 'Rodada 3': return '#E5C75B';
      	case 'Rodada 4': return '#AEA1D4';
      	case 'Rodada 5': return '#AAD8DF';
      	case 'Rodada 6': return '#ECDDE4';
        case 'Rodada 7': return '#CAFAC8';
        case 'Rodada 9': return '#FAB792';
        case 'Rodada 10': return '#47C4BE';
        case 'Rodada 11': return '#A8B849';
        case 'Rodada 12': return '#4847AF';
        case 'Rodada 13': return '#E47235';
        case 'Rodada 14': return '#C295C4';
        case 'Rodada 15': return '#B0D9D5';
        case 'Partilha 1': return '#96A6AD';
        case 'Partilha 2': return '#B7C0FB';
        case 'Partilha 3': return '#C5B9C0';
        case 'Partilha 4': return '#83427E';
        case 'Partilha 5': return '#35F5D3';
        	break;
      }
  }
  ...
  var BLOCOS_PETROLEO = L.geoJSON(blocos_petroleo.responseJSON, {
    ...
    var CAMPOS_PETROLEO = L.geoJSON(campos_petroleo.responseJSON, {
      onEachFeature: function( feature, layer ){
        layer.bindPopup(
          "<b>Campo: </b>" + feature.properties.NOM_CAMPO + "<br>" +
          "<b>Bacia:  </b>" + feature.properties.NOM_BACIA +  "<br>" +
          "<b>Área (km &#178; ): </b>" + feature.properties.AREA.toLocaleString('de-DE', { maximumFractionDigits: 2 })+  "<br>" +
          "<b>Operador:  </b>" + feature.properties.OPERADOR_C +  "<br>" +
          "<b>Rodada:  </b>" + feature.properties.NUM_RODADA +  "<br>" +
          "<b>Número do contrato: </b>" + feature.properties.NUM_CONTRA +  "<br>" +
          "<b>Data de Início: </b>" + feature.properties.DAT_INICIO +  "<br>" +
          "<b>Data da descoberta: </b>" + feature.properties.DAT_DESCOB
        );
      }
    }
  );
  ...
  var groupedOverlays = {
    ...
    "Petróleo e Gás": {
      ...
      "Campos de Petróleo" : CAMPOS_PETROLEO
    }
    //"Ambiental": {
